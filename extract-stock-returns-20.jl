...
csv_file_path = "stock-returns-20.csv"
stock_tickers = [:BA, :BRKB, :GS, :JNJ, :JPM, :KO, :MCD, :PFE, :WMT, :XOM, :LLY, :V, :CAT, :BAC, :GE, :PG, :ABBV, :HD, :PM, :MRK]
stock_labels = ["BA", "BRK.B", "GS", "JNJ", "JPM", "KO", "MCD", "PFE", "WMT", "XOM", "LLY", "V", "CAT", "BAC", "GE", "PG", "ABBV", "HD", "PM", "MRK"]
...
if do_plots == true
    ...
    labels = permutedims(stock_labels)
    ...
    display(plt)
    savefig(plt, "figures/stock-returns-20.pdf")
