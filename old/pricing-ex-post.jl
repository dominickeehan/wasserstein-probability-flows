...
WPF_revenues = parameter_fit(WPF_weights, 0.1*[LinRange(0.2,1,9); LinRange(2,10,9); LinRange(20,100,9); LinRange(200,1000,9); LinRange(2000,10000,9)])
